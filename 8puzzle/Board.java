...
public class Board {
    ...
    public Board(int[][] tiles) {
        ...
        // set tiles array wich represents initial board
        ...
        // create a copy of initial tiles array modified by swapping a pair of tiles-
        // input for twin board constructor
        twinConstruction();
    ...
    public Board twin() {
        if (twinTiles == null) throw new IllegalArgumentException("No tiles array to create twin board.");
        Board twinBoard = new Board(twinTiles);

        return twinBoard;
    }

    private void twinConstruction() {
        int tileOneRow, tileOneCol, tileTwoRow, tileTwoCol; // indexes of swapping tiles
