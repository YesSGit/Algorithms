...
public class Point implements Comparable<Point> {
    ...
    // private final Comparator<Point> SLOPE_ORDER;
    ...
    public double slopeTo(Point that) {
        ...
        return ((double) (that.y - this.y)) / (that.x - this.x);    // general case
    }
    ...
    public static void main(String[] args) {
        /* YOUR CODE HERE */
        double slope;
        Point pointP = new Point(10499, 29557);
        Point pointQ = new Point(10499, 29481);
